...
class ZEPHYRORPOHandler(LLMContentHandler):
...
content_handler = ZEPHYRORPOHandler()


class ZEPHYRORPOAdapter(ModelAdapter):
...
registry.register(r"(?i)sagemaker\.huggingfaceh4-zephyr-orpo*", ZEPHYRORPOAdapter)
